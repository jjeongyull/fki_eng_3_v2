...
$(document).on('click', '#btn_go_ko', function() {
  let path = "https://www.fki.or.kr/webzine/K03/";
  const currentPath = window.location.pathname.split('/').pop();

  if(currentPath == "" || currentPath === "sub_52.html" || currentPath === "sub_51.html" || currentPath === "sub_53.html" || currentPath === "sub_61_1.html" || currentPath === "sub_61.html"){
    path = path;
  }else{
